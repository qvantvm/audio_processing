...
**Excitation:** bow, pick, breath noise. **Resonator:** string/bore modes. **Radiation:** body filter (often extra delay/FIR) [@smith2010physical].
...
3. Why fractional delay needed for accurate pitch?
...
**Next chapter:** Chapter 20 — *Neural Audio Representations*.

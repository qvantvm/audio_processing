...
**FIR:** $h[n]$ finite length— always stable, linear phase possible. **IIR:** recursive; $h[n]$ infinite but parameterized compactly (Chapter 10).
...
4. **Assuming IR is minimum-phase** (Chapter 12)— linear-phase IR adds pre-ringing.
...
**Next chapter:** Chapter 10 — *Filters: FIR, IIR, and the Z-Transform*.

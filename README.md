...
**No chapter is `polished` yet.** Chapters **01–15** are `pedagogically reviewed`; **00, 16–22**,
...
| Job | Checks |
|-----|--------|
| `format` | `black`, `ruff`, `check_formatting.py`, `check_representation_lens.py`, `check_pedagogy_verify.py` |
